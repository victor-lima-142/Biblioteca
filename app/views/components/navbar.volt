<nav class="navbar p-0 fixed-top navbar-expand-lg bg-dark bg-gradient">
	<div class="container-fluid">
		{{ link_to(['for': 'livro.lista', 'name': 'livro.lista'], '<img src="img/logo.png" id="logo-nav">', 'class': 'navbar-brand', 'title': 'Início') }}
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item">
					{{ link_to(['for': 'livro.lista', 'name': 'livro.lista'], '<i class="material-icons material-icons-lg">home</i>', 'class': 'nav-link', 'title': 'Início', 'aria-current': 'page') }}
				</li>
				<li class="nav-item">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu bg-dark bg-gradient" aria-labelledby="adicionarDropdown">
						<li>
							{{ link_to(['for': 'livro.novo', 'name': 'livro.novo'], 'Novo Livro', 'class': 'dropdown-item text-custom') }}
						</li>
						<li>
							{{ link_to(['for': 'livro.novo', 'name': 'livro.novo'], 'Novo setor', 'class': 'dropdown-item text-custom') }}
						</li>
						<li>
							{{ link_to(['for': 'livro.novo', 'name': 'livro.novo'], 'Novo Cliente', 'class': 'dropdown-item text-custom') }}
